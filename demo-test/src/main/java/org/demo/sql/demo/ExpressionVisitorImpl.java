...
//        logger.info("inExpression{}",inExpression);
        if (inExpression.getLeftExpression() != null) {
            inExpression.getLeftExpression()
                    .accept(new ExpressionVisitorImpl());
        } else if (inExpression.getLeftItemsList() != null) {
//            inExpression.getLeftItemsList().accept(new FromItemVisitorImpl());
        }
//        inExpression.getRightItemsList().accept(new SelectVisitorImpl());
        ItemsList in = inExpression.getRightItemsList();
        if(in instanceof SubSelect){
            SubSelect select = (SubSelect)in;
            select.accept(new FromItemVisitorImpl());
        }
    }
