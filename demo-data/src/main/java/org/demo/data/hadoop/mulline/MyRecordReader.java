...
public class MyRecordReader extends RecordReader<LongWritable, Text> {
	...
	public MyRecordReader(Configuration context){
//		super(context);
	}
	public MyRecordReader(byte[] recordDelimiter) {
	...
	public void initialize(InputSplit genericSplit, TaskAttemptContext context) throws IOException {
		...
		if (null != codec) {
			...
			if (codec instanceof SplittableCompressionCodec) {
				...
				in = new MyCompressedSplitLineReader(cIn, job, this.recordDelimiterBytes);
				start = cIn.getAdjustedStart();
				end = cIn.getAdjustedEnd();
				filePosition = cIn;
			} else {
				in = new MySplitLineReader(codec.createInputStream(fileIn, decompressor), job, this.recordDelimiterBytes);
				filePosition = fileIn;
			}
		} else {
			fileIn.seek(start);
			in = new MyUncompressedSplitLineReader(fileIn, job, this.recordDelimiterBytes, split.getLength());
			filePosition = fileIn;
		}
